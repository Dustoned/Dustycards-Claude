...
export const patchNotes: PatchNoteEntry[] = [
  {
    ...
    highlights: [
      ...
      "Fullscreen Card Detail now anchors its action dock directly to the phone viewport and keeps the sticky section tabs below the iPhone status area while scrolling.",
