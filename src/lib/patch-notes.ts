...
export const patchNotes: PatchNoteEntry[] = [
  {
    ...
    highlights: [
      ...
      "Signal Radar Card Detail no longer reserves the phone header twice: its loading skeleton matches the finished layout, the random top gap is gone and primary actions sit in the normal page flow without covering card information.",
