...
export const patchNotes: PatchNoteEntry[] = [
  {
    ...
    highlights: [
      ...
      "New registrations now wait for admin approval. Pending accounts receive a clear login popup and create one durable admin-only Action Center notification linking directly to the approval queue, while locking an account immediately ends its sessions.",
