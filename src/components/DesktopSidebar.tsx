...
export default function DesktopSidebar({ summary }: { summary: DesktopSidebarSummary }) {
  ...
  return (
    <aside className="pointer-events-none fixed inset-y-0 left-0 z-50 hidden h-dvh w-[16rem] xl:block">
      <div className="pointer-events-auto flex h-[calc(100dvh-5.25rem)] min-h-0 w-full flex-col overflow-y-auto overscroll-contain px-3 py-4 pr-2.5 [scrollbar-color:rgba(255,255,255,0.22)_transparent] [scrollbar-width:thin] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-track]:bg-transparent">
