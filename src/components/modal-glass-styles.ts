export const modalOverlayClass =
  "fixed inset-0 flex items-center justify-center bg-black/72 p-4 backdrop-blur-xl";
...
export const modalPanelBaseClass =
  "glass relative flex max-h-[calc(100dvh-2rem)] w-full flex-col overflow-hidden rounded-3xl border border-white/12 bg-[#0d0d10]/92 text-white shadow-2xl shadow-black/45";
...
export const modalActionRowClass =
  "mt-6 flex gap-3 rounded-[22px] border border-white/10 bg-white/[0.055] p-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-xl max-[640px]:mt-4 max-[640px]:gap-2 max-[640px]:rounded-2xl max-[640px]:p-2";

export const modalCloseButtonClass =
  "inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/8 text-white/60 transition-colors hover:bg-white/12 hover:text-white max-[640px]:h-8 max-[640px]:w-8";
